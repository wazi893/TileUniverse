...
impl WireRoute {
    ...
    pub fn horizontal(from: (&str, &str), to: (&str, &str), y: usize, x_start: usize, x_end: usize) -> Self {
    ...
    pub fn vertical(from: (&str, &str), to: (&str, &str), x: usize, y_start: usize, y_end: usize) -> Self {
        let mut path = Vec::new();

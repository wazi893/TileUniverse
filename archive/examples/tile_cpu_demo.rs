...
fn main() {
    ...
    println!("Pipeline stages: {} → critical path {} deltas",
    ...
    println!("  Initialization: {} deltas, critical path {} deltas",
    ...
    for cycle in 0..6 {
        ...
        println!("Cycle {}: {} deltas, critical path {} deltas",
            cycle,
            stats.total_deltas,
    ...
    println!("  Instant execution          {} deltas per cycle",
        metrics.max_critical_path);
    println!("  N/A                        {:.1} MHz estimated max",
